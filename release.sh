...
PUBLISH=./GrokAssembly/bin/Release/net6.0/publish
TEMP=./GrokAssembly/bin/Release/net6.0/temp
...
dotnet ./GrokAssembly/bin/Release/net6.0/publish/GrokAssembly.dll ./GrokAssembly/bin/Release/net6.0/publish/GrokAssembly.dll
